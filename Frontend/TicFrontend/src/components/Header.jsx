    ...
    return (
        <header className="flex flex-col sm:flex-row justify-between items-center sm:px-10 lg:px-30 bg-gradient-to-t from-white to-gray-200 h-15">
            ...
            <nav className="flex py-5 sm:py-0 gap-2 sm:gap-15">
                <NavLink to={"/"} className={({ isActive }) => isActive ? "text-lg bg-green-300 rounded-xl py-2 px-3 font-medium transition-all duration-400 hover:text-gray-200" : "text-lg font-medium py-2 px-3 transition-all duration-400 hover:text-gray-200"}>Home</NavLink>
            ...
            <Link to="/login" className="hidden sm:flex items-center gap-3 bg-black text-white px-2 lg:px-4 py-2 transition-all duration-500 hover:bg-gray-500 rounded-4xl">
