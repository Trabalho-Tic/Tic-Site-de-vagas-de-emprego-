...
function Card({ vaga }) {
    ...
    return (
        <div onClick={() => navigate(`/vagas/${vaga.id}`)} className="h-auto w-full md:w-90 lg:w-100 border-1 border-gray-400 p-4 rounded-sm shadow-lg transition-all duration-300 hover:shadow-green-300 hover:-translate-y-1">
