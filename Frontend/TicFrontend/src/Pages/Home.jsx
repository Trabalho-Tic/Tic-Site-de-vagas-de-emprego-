        ...
        <>
            ...
            <section className="flex flex-col justify-center items-center gap-10 py-10">
                ...
                <div className="flex gap-5">
                    ...
                    <button className="bg-gradient-to-t from-gray-50 to-gray-500 p-5 rounded-4xl transition-all duration-400 shadow-xl hover:-translate-y-1"><Search size={20} /></button>
                </div>
            </section>
            <section className="bg-gradient-to-t to-white from-gray-100 sm:px-0 lg:px-25 py-15 flex flex-col items-center">
                <p className="text-3xl font-semibold pb-6">Vagas abertas recentemente</p>
