        ...
        <>
            ...
            <section className="w-full py-20">
                ...
                <div className="flex flex-col gap-5 justify-center items-center pt-20 px-100">
                    ...
                    <p className="text-xl font-medium text-center">O Jobior incorpora acessibilidade como premissa da plataforma — com suporte a leitores de tela, feedback de foco visual estruturado — promovendo autonomia, desenvolvimento de carreira e participação plena no mercado de trabalho e na força de trabalho global.</p>
                </div>
                ...
                <div className="flex flex-col gap-5 justify-center items-center pt-20 px-100">
                    ...
                    <p className="text-xl font-medium text-center">O Jobior nasceu como uma ideia em 2025, motivado pela necessidade de ampliar a empregabilidade de profissionais criativos juniores, tendo a acessibilidade digital para Pessoas com Deficiência (PCD) como pilar central.</p>
                    ...
                    <p className="text-xl font-medium text-center">Sob sua governança institucional e acadêmica, o Jobior amplia seu impacto ao oferecer vagas acessíveis, recursos estruturados de carreira e redes de conexão profissional, com fluxos compatíveis, promovendo a participação plena de pessoas PCD no workforce criativo e na economia global.</p>
                </div>
